 ...
 * gameoptions.inc.php
 *
 * Marrakech game options description
 * 
 ...
 *        with the same ID (see "initGameStateLabels" in marrakech.game.php)
 *
...
$game_options = array(
  ...
  100 => array(
      ...
      'values' => array(
                      ...
                      2 => array( 'name' => totranslate('yes'), 'tmdisplay' => totranslate( 'Rotate Assam at the end of turn' ) ),
                  )
         )
